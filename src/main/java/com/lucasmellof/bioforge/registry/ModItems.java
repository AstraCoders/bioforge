...
public class ModItems {
    ...
    public static final DeferredHolder<Item, BlockItem> CENTRIFUGE_ITEM = ITEMS.register("centrifuge", (prop) -> new GeckoBlockItem(ModBlocks.CENTRIFUGE_BLOCK.get(), new Item.Properties()));
}
